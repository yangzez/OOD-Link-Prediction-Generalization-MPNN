...
def main(seed1, seed2):
    ...
    best_valid_acc = 0
    valid_losses = []
    checkpoint_file_name = "7-30-ddi" + str(args.agg) + str(args.hid_dim)+str(args.num_layers)+ str(args.num_nodes) + str(args.method) + str(args.noinn) + "model_GNN_checkpoint.pth.tar"
    checkpoint_file_name_Y ="7-30-ddi" + str(args.agg) + str(args.hid_dim)+str(args.num_layers)+ str(args.num_nodes) + str(args.method) + str(args.noinn) + "model_link_checkpoint.pth.tar"
    n = 1
